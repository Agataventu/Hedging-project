function [VegaUpSensitivity,eta_Vega, kappa_Vega, sigma_Vega] = computeVegaUp(fwd, disc_pricing, Nsim, timegrid, ...
    alpha, eta0, k0, sigma0, price, fwd_prices, C_bp, P_bp, CallStrikes, PutStrikes, t0, disc, CallexpDates, PutexpDates, dates)
